...
public class HereticsControllerV2 {
    ...
    public HttpEntity<ReligiousPokemon> getReligiousPokemon(@RequestHeader("key") String requestKey) {
        ...
        pokemonAdviceService.savePokemonAdvice(religiousPokemon.getLifeAdvice());
        pokemonDataService.savePokemonData(religiousPokemon.getName(), religiousPokemon.getAbility());
